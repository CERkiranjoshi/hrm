...
export class ApplyLeaveComponent implements OnInit {
  ...
  createPolicyFormGroup() {
    return new FormGroup({
      ...
      roles: new FormControl('Earned Leave', {
        validators: [Validators.required]
      }),
      ...
      claimant_name: new FormControl('Jay Desai', {
        validators: [Validators.required]
      }),
  ...
  fetchDropdownValues() {
    ...
    this.dropdownValues.leave_types = ['Casual leave','Sick leave','Earned Leave','Maternity Leave','Paternity leave','Leave without pay']
  ...
  backToLeaveList(event){
    this.router.navigate(['leavelists']);
  }
