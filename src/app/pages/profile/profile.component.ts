...
export class ProfileComponent implements OnInit {
  ...
  createPolicyFormGroup() {
    return new FormGroup({
      employee_id: new FormControl('SAAS_MUMBAI_121', {
        validators: [Validators.required]
      }),
      employee_name: new FormControl('Kiran Joshi', {
        validators: [Validators.required]
      }),
      ...
      reporting_manager: new FormControl('Jayesh Desai', {
        validators: [Validators.required]
      }),
      ...
      employee_phone: new FormControl('9823194812', {
        validators: [Validators.required, phoneNumberValidator]
      }),
      employee_age: new FormControl('29', {
        validators: [Validators.required, Validators.pattern('^[0-9]+\d*$')]
      }),
      employee_email: new FormControl('kj@gmail.com', {//https://angular-templates.io/tutorials/about/angular-forms-and-validations '^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$'
        validators: [Validators.required, Validators.pattern('^([\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,6})?$')]
      }),
      claimant_address1: new FormControl('906 Hanuman Nagar', {
        validators: [Validators.required]
      }),
      claimant_address2: new FormControl('Andheri East , Mumbai 400087', {
        validators: [Validators.required]
      }),
      claimant_pincode: new FormControl('40087', {
        validators: [Validators.required, Validators.pattern('^[0-9]*$'), Validators.maxLength(6),
        Validators.minLength(6)]
      }),
      claimant_state: new FormControl('Maharashtra', {
        validators: [Validators.required]
      }),
      claimant_city: new FormControl('Mumbai', {
        validators: [Validators.required, Validators.pattern('^[a-zA-Z ]+$'), Validators.minLength(3)]
      }),
      claimant_gender: new FormControl('', {
        validators: [Validators.required]
      }),
      claimant_doa: new FormControl( new Date('15-Oct-2018'), {
        validators: [Validators.required]
      }),
  ...
  fetchDropdownValues() {
    ...
    this.dropdownValues.state=['Maharashtra','Gujarat','Delhi']
